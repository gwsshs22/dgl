...
def train(train_dataloader, val_dataloader, test_dataloader, device, model):
...
if __name__ == '__main__':
    ...
    train(train_dataloader, val_dataloader, test_dataset, device, model)
    ...
    torch.save(model.state_dict(), "/home/gwkim/gnn_models/gat_ppi_10_20_30.pt")