RESULT_ROOT_DIR=/nfs/gwkim/omega_nsdi25/models/240418

LOCAL_RANK=1

for GRAPH_NAME in "yelp" "amazon" "ogbn-products" "flickr" "reddit"  "ogbn-papers100M"
do
...
python -m omega.training.train_v2 --result_dir $RESULT_ROOT_DIR/$GRAPH_NAME/${GNN}/nl_2_lr_${LR}_do_${DROPOUT}_norm_both --lr $LR \
  --graph_name $GRAPH_NAME --num_epochs 30 --patience 30 \
